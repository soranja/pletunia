...
function Hero() {
  return (
    <section className="bg-hero bg-cover grow grid grid-cols-1 lg:grid-cols-hero mt-20 px-20 lg:pl-40 lg:pr-0 text-white relative">
      <div className="z-10 mb-20 mt-5 gap-y-6 md:gap-y-10 lg:mb-0 flex flex-col items-center lg:items-start justify-start lg:justify-evenly">
        <div className="flex items-center">
          <div className="lg:hidden mt-5 flex justify-center">
            <img className="w-8/12" src={Lighthouse} alt="charm" />
          </div>
